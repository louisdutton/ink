  ...
  const { username } = useSockets();
	...
	return (
      ...
      <div className='hidden sm:block relative flex-1'>
        <Image src='/bg.jpg' layout='fill' className='pointer-events-none' objectFit='cover'/>
      </div>
      <div className="p-8 flex items-center justify-center bg-white dark:bg-neutral-800 shadow-lg z-10 w-full sm:w-2/5 min-w-fit">
